...
% the 'noext' option. Use the 'nopath' option to ignore any filepath. Use
% the 'nodot' option to remove the folder names "." and ".." from the array.
%
%%% Example:
% P = 'C:\SomeDir\SubDir';
...
%     = 'nodot' removes the names "." and ".." from the output array.
...
%
idd = strcmpi(varargin,'nodot');
assert(nnz(idd)<2,...
	'SC:natsortfiles:nodot:Overspecified',...
