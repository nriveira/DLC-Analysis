function [centroids,deltas,deltapercentiles,sleep_awake_frames,non_sleep_frames] = DLC_awake_sleep_classify(dlcfiles,motionThreshold,timeThreshold,fps, motionData)
%{
    INPUTS:
...
centroids(:,1) = motionDataStruc.xy.mdbdy(:,1);
centroids(:,2) = motionDataStruc.xy.mdbdy(:,2);
